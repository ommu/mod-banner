 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_banner_statistics".
 *
 * The followings are the available columns in table 'ommu_banner_statistics':
...
class BannerStatistics extends CActiveRecord
{
	 ...
	 * @return BannerStatistics the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('statistic_key, note', 'required'),
			array('statistic_key', 'length', 'max'=>32),
			array('note', 'length', 'max'=>64),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('statistic_key, flag, note', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['BannerStatistics_sort']))
