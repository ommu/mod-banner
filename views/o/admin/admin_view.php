...
<div class="box">
	<?php $this->widget('zii.widgets.CDetailView', array(
		...
		'attributes'=>array(
			...
			array(
				'name'=>'published_date',
				'value'=>!in_array($model->published_date, array('0000-00-00','1970-01-01','0002-12-02','-0001-11-30')) ? $this->dateFormat($model->published_date) : '-',
			),
			array(
				'name'=>'expired_date',
				'value'=>!in_array($model->expired_date, array('0000-00-00','1970-01-01','0002-12-02','-0001-11-30')) ? $this->dateFormat($model->expired_date) : '-',
			),
			array(
				'name'=>'creation_date',
