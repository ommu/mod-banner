...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Back To Banner Views'), 'url' => Url::to(['view/index']), 'icon' => 'table'],
];
			...
			array_push($columnData, [
				...
				'buttons' => [
					'view' => function ($url, $model, $key) {
						...
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'View Banner View History')]);
					},
