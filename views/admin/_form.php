...
<?php echo $form->field($model, 'url', ['template' => '{label}<div class="col-md-9 col-sm-9 col-xs-12">{input}{error}<span class="small-px">example: http://sudaryanto.id</span></div>', 'options' => ['class' => 'form-group', 'style' => $model->linked_i == 0 ? 'display: none' : '']])
	->textInput()
